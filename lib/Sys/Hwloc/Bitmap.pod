...
Sys::Hwloc::Bitmap is the Perl namespace used for B<struct hwloc_cpuset>
and B<struct hwloc_nodeset> data since hwloc v1.1.
...
every hwloc C function that gets a hwloc_bitmap pointer as first argument
...
This method is not part of the hwloc C API. It is the reverse of B<$string = $map-E<gt>sprintf_list>.
