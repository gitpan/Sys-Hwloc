...
Sys::Hwloc::Obj is the Perl namespace used for B<struct hwloc_obj>
data.

The Sys::Hwloc::Obj class provides an object-oriented interface
for members of B<struct hwloc_obj>, and for hwloc C functions that act on
...
A Sys::Hwloc::Obj instance is retrieved either from a Sys::Hwloc::Topology instance,
...
The corresponding hwloc C struct member points to a B<struct hwloc_obj_memory_s>.

As with hwloc v1.1, the memory hashref consists of the following:
...
The corresponding hwloc C struct member points to a B<union hwloc_obj_attr_u>.

The content of the attrs hashref depends on the object type and the hwloc version.
...
Before hwloc v1.1, this method returns an instance of Sys::Hwloc::Cpuset.

Since hwloc v1.1, this method returns an instance of Sys::Hwloc::Bitmap. A class
...
Before hwloc v1.1, this method returns an instance of Sys::Hwloc::Cpuset. There is
...
The corresponding hwloc C struct member points to an array of B<struct hwloc_obj_info_s>.
...
This method is an alias of B<Sys::Hwloc::hwloc_obj_type_sprintf>().
...
This method is an alias of B<Sys::Hwloc::hwloc_obj_attr_sprintf>().
...
This method is an alias of B<Sys::Hwloc::hwloc_obj_cpuset_sprintf>().
